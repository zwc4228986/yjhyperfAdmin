        ...
        >
          <view class="u-tabs__wrapper__nav" ref="u-tabs__wrapper__nav">
            <view
              ...
              :class="[`u-tabs__wrapper__nav__item-${index}`, item.disabled && 'u-tabs__wrapper__nav__item--disabled', index == innerCurrent && 'active']"
            >
              <u-image v-if="item['img']" customStyle="margin-bottom: 30rpx;" width="92rpx" height="92rpx" :src="item['img']"></u-image>
              <text :class="[item.disabled && 'u-tabs__wrapper__nav__item__text--disabled']" class="u-tabs__wrapper__nav__item__text" :style="[textStyle(index)]">
                {{ item[keyName] }}
              </text>
              <text v-if="item['sonName']" class="lit-text">{{ item['sonName'] }}</text>
              <view class="line" v-if="isLine && index != list.length - 1"></view>
            </view>
          </view>
        </scroll-view>
      </view>
    ...
    &__nav {
      ...
      .active {
        ...
        .lit-text {
          ...
          border-radius: 20rpx;
          overflow: hidden;
          background: linear-gradient(to right, #f54432, #febc5e);
        }
      }
    }
  }
