<template>
	<view :style="colorStyle">
		<view class="lottery" v-if="lotteryShow && loading">
			...
			<view class="grids">
				<image class="grids-bag" src="/static/images/lottery-bag.png" mode=""></image>
				<view class="grids-top">
					<image src="/static/images/font-left.png" mode=""></image>
					<view class="grids-title">
						<view>每次抽奖消耗</view>
						<view class="grids-frequency">{{factor_num}}</view>
						<view>小豆</view>
					</view>
					<image src="/static/images/font-right.png" mode=""></image>
				</view>
	...
	.followCode {
		.pictrue {
			...
			.code-bg {
				...
				width: 100%;
				height: 100%;
				// background-image: url('#{$app-url}l}/images/code-bg.png');
