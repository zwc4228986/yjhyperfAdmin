...
export function getCategoryList(data) {
	return request.post('/api/product/category/lists', data, {
		noAuth: true,
		URL:3
	});
}
...
export function getProductslist(data) {
	return request.post('/api/product/lists', data, {
		noAuth: true,
		URL:3
	});
}
 ...
 * 
 */
export function getMuBiaolist(data) {
	return request.post('/api/product/mubiao',data,{
		URL:2
	});
}
