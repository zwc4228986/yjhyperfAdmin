...
export function getStatistics(data={}) {
	return request.post('/tasker/task/statistics',data,{
		URL:2
	});
}
/**
...
export function userShare() {
	return request.post('/user/sign/task/do',{code:'share'},{
		URL:2
	});
...
export function addTaskBlack(data){
  return request.post('/user/task/task/black',data,{
  	URL:2
  });
}