<template>
	<div class="user-bar">
		<div class="screen panel-item hidden-sm-and-down" @click="screen">
			<el-icon :size="16"><el-icon-fullscreen /></el-icon>
		</div>
		<div class="msg panel-item" @click="showMsg">
			<el-badge
				...
				type="danger"
			>
				<el-icon :size="16"><el-icon-chatlineround /></el-icon>
			</el-badge>
				...
				<el-container>
					...
					<el-footer>
						<el-button type="primary" size="small"
							>消息中心</el-button
						>
						<el-button size="small" @click="markRead"
							>全部设为已读</el-button
						>
					</el-footer>
				</el-container>
		...
		<el-dropdown trigger="click" @command="handleUser" style="height: 100%">
			<div class="user panel-item">
				<el-avatar :size="30" :src="userDetail?.icon_path?.full_path"></el-avatar>
				<label >{{ userDetail?.nickname}}</label>
				<el-icon :size="14" class="el-icon--right"><el-icon-arrowdown  /></el-icon>
			</div>
			<template #dropdown>
				<el-dropdown-menu>
