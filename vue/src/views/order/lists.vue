  ...
  <el-container>
    <el-header class="header-tabs">
      <el-tabs type="card">
        ...
        <el-tab-pane label="拼团订单" name="2"></el-tab-pane>
        <el-tab-pane label="秒杀订单" name="3"></el-tab-pane>
        <el-tab-pane label="砍价订单" name="4"></el-tab-pane>
        <el-tab-pane label="预售订单" name="5"></el-tab-pane>
      </el-tabs>
    </el-header>
