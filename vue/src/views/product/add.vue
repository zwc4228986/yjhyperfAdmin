		...
		getProductDetail() {
			this.$HTTP()
				...
				.then((res) => {
					...
					formValidate.prepend(this.collect(res.product_resource).firstWhere('type', 1).baidu_url, "baidu_url");
					formValidate.prepend(this.collect(res.product_resource).firstWhere('type', 1).baidu_code, "baidu_code");
					formValidate.prepend(this.collect(res.product_resource).firstWhere('type', 0).file_id, "resource_id");
