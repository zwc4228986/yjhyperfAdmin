<template>
  <el-container>
    ...
    <el-main class="nopadding">
      <yjTableTree ref="yjTable" rowKey="id"  :params="formParams" :formConfig="formConfig">
        <template v-slot:op>
          <el-table-column
            label="操作"
            fixed="right"
          ...
          >
            <template #default="scope">
              ...
              <el-button size="small" type="primary" @click="onEdit(scope.row, scope.$index)">
                编辑
              </el-button>
			  <el-button
				  type="danger"
...
export default {
  ...
  methods: {
	...
	　console.log(config_id);
      this.$modalForm(
        this.$HTTP().params({ config_id }).post(`/form/${this.yjCode}/update`)
      ).then((res) => {
