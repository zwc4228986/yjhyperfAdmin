                                ...
                                <div class="card w-100">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-pills nav-pills-soft flex-column fw-bold gap-2 border-0">
                                            ...
                                            <li class="nav-item" data-bs-dismiss="offcanvas">
                                                <a class="nav-link d-flex mb-0" href="#nav-setting-tab-3" data-bs-toggle="tab"> <img class="me-2 h-20px fa-fw" src="assets/images/icon/shield-outline-filled.svg" alt=""><span>我的下载</span></a>
                                            </li>
                                        </ul>
                                        <!-- Side Nav END -->
