...
namespace YjHyperfAdminPligin\Form\FormBuilder;


use YjHyperfAdminPligin\Form\FormBuilder\Contract\BootstrapInterface;
use YjHyperfAdminPligin\Form\FormBuilder\Contract\ConfigInterface;
use YjHyperfAdminPligin\Form\FormBuilder\Exception\FormBuilderException;
use YjHyperfAdminPligin\Form\FormBuilder\UI\Iview\Bootstrap as IViewBootstrap;
use YjHyperfAdminPligin\Form\FormBuilder\UI\Elm\Bootstrap as ElmBootstrap;
...
class Form
{
     ...
     * @return $this
     */
    public function formData(callable|array $formData)
    {
        if(is_callable($formData)){
            $formData = $formData();
        }
        $this->formData = collect($formData)->toArray();
        return $this;
    }
