...
use  YjHyperfAdminPligin\Form\FormBuilder\UI\Elm\Components\Tree;
use  YjHyperfAdminPligin\Form\FormBuilder\UI\Elm\Components\TreeData;
use YjHyperfAdminPligin\Form\FormBuilder\UI\Elm\Components\TreeSelect;
...
trait TreeFactoryTrait
{
     ...
     * @return TreeSelect
     */
    public static function treeSelected($field, $title, $value = null)
    {
        return new TreeSelect($field, $title, $value);
    }
